...
import { posterUrl, getWatchProviders, providerLogoUrl, genresOf, getTitleDetails, spokenLanguagesOf, googleSearchUrl } from './tmdb-client.js';
...
function render() {
  ...
  const releaseDate = formatReleaseDate(t.release_date);
