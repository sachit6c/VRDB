...
import { initDetailSheet, openDetailSheet } from './detail-sheet.js';

const SECTION_ORDER = [STATES.WANT_NOW, STATES.WANT_LATER, STATES.WATCHED];
...
export function initMine() {
  ...
  initDetailSheet({ onChange: refreshMine });
