...
// Compact vote count for display: 842 -> "842", 1234 -> "1.2k", 1500000 -> "1.5M".
...
export const tmdbClient = { tmdb, searchMulti, posterUrl, yearOf, formatVoteCount, titleOf, genresOf, getTitleDetails, spokenLanguagesOf, googleSearchUrl, getTrending, getRelated, discoverByGenre, getWatchProviders, providerLogoUrl };
